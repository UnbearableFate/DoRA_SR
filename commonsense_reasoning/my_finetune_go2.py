...
def train(
        ...
        # scheduler params
        repeat_n: int = 2,
        repeat_warmup_ratio: float = 0.03,   # 2% of total steps
        repeat_decay_ratio: float = 0.03,    # 8% of total steps
        repeat_end_lr_rate: float = 0.97,     # decay to 30% of max lr
